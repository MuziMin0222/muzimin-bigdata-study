package com.muzimin.exercise.issmart
...
object SurveyCleanJob {
  def main(args: Array[String]): Unit = {
    ...
    val sourceDF = spark.read
      ...
      .load("D:\\Hypers\\华为\\EcRule.xlsx")
      .na.fill("")
      //.withColumn("L1", trim(col("L1")))
      //.withColumn("rule_name", when(col("L2") =!= "",concat_ws("-", col("L1"), col("L2"))).otherwise(col("L1")))
